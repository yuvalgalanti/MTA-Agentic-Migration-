...
export const migrationRoutes: IRoute<DevPathValues>[] = [
  ...
  {
    path: Paths.agenticWorkflowDetails,
    comp: MigrationWorkflowDetails,
    exact: false,
  },
  {
    path: Paths.agenticWorkflows,
    comp: MigrationWorkflows,
    exact: false,
  },
  {
    path: Paths.agenticWorkflowRuns,
    comp: WorkflowRunsPage,
    exact: false,
  },
  {
